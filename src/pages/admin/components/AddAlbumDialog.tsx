...
import {
  ...
  DialogTrigger,
  DialogFooter,
} from "@/components/ui/dialog"; // Updated to include DialogFooter
    ...
    <Dialog open={albumDialogOpen} onOpenChange={setAlbumDialogOpen}>
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4 py-4">
          ...
          />
          <div
            className="flex items-center justify-center p-6 border-2 border-solid border-zinc-700 bg-zinc-800 rounded-lg cursor-pointer"
            onClick={() => fileInputRef.current?.click()}
          >
            <div className="text-center">
              <div className="p-3 bg-zinc-700 rounded-full inline-block mb-2">
        ...
        <DialogFooter className="flex justify-end gap-2 p-4 bg-zinc-900 border-t border-zinc-700">
          <Button
            variant="outline"
